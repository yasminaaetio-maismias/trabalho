...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #ffffff; /* Texto geral em branco */
        ...
        img {
            ...
            border: 4px solid #ff0000; /* Borda vermelha para destacar */
            border-radius: 8px;
        }

        header {
            text-align: center;
            border-bottom: 2px solid #ff0000; /* Linha divisória vermelha */
            padding-bottom: 20px;
            margin-bottom: 30px;
        }

        h1 {
            color: #ff0000; /* Título principal em vermelho */
        }
        ...
        h2 {
            color: #ff0000; /* Títulos dos posts em vermelho */
            margin-top: 30px;
        }
    </style>
</head>
<body>
    ...
    <main>
        ...
        <!-- Post 3: Filosofia das Letras -->
        <h2>💡 3. A Filosofia de Chorão</h2>
        <p>As letras não eram apenas rimas, eram lições de vida sobre <strong>persistência, amizade e humildade</strong>. O Charlie Brown Jr. mostrou que, mesmo vivendo em um mundo difícil, é preciso manter a cabeça erguida e o skate no pé.</p>
    </main>
